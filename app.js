	...
	if(force){
		models.Category.bulkCreate([
			...
			models.Product.bulkCreate([
				...
				{title:'More Beer', description:'This is good beer', category:'stout', price:14, inventory: 10, image_url:'https://502brews.files.wordpress.com/2013/05/draft-beer-small.jpg'},
